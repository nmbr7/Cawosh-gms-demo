  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
      ...
      <div className="mt-2 text-xs text-gray-500">
        ...
        owner&apos;s handbook for your specific vehicle. Note: The appearance
        and color of lights may vary. Check the owner&apos;s handbook for your
        specific vehicle.
      </div>
    </div>
  );
              ...
              <div className="mt-3 border-l border-blue-100 pl-4">
                {flattenedSubsections.map((sub: unknown, subIdx: number) => {
                  ...
                  const isSubOpen =
                    ...
                    openSectionPath
                      .slice(0, subPath.length)
                      .every((v: string, idx: number) => v === subPath[idx]);
                  return (

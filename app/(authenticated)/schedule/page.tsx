...
export default function SchedulePage() {
  ...
  const [newBookingTime, setNewBookingTime] = useState<string | undefined>(undefined);
  ...
  useEffect(() => {
    if (selectedBay === "all" && viewMode !== viewType.Month) {
      setSelectedBay(1);
    }
  ...
  useEffect(() => {
    filteredBookings();
  }, [filteredBookings, storeBookings]);
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              <button onClick={() => setIsCalendarOpen(true)} className="text-2xl font-semibold">
          ...
          <div className="flex gap-4">
            <Select
              ...
              onValueChange={(val) => setSelectedBay(val === "all" ? "all" : parseInt(val))}
            >
              <SelectTrigger className="w-[180px] bg-white">
                <SelectValue placeholder="Select bay" />
              </SelectTrigger>
              <SelectContent>
                {viewMode === viewType.Month && <SelectItem value="all">All Bays</SelectItem>}
                {[1, 2, 3].map((bay) => (
            ...
            <Select value={viewMode} onValueChange={(val) => setViewMode(val as viewType)}>
              <SelectTrigger className="w-[180px] bg-white">

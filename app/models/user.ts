...
export class User {
  ...
  get accessLevel() { return this.data.accessLevel; }
  get department() { return this.data.department; }
  get joiningDate() { return this.data.joiningDate; }
  get employmentType() { return this.data.employmentType; }
  get workingHours() { return this.data.workingHours; }
  get managedDepartments() { return this.data.managedDepartments; }
  get teamSize() { return this.data.teamSize; }
  get reportingTo() { return this.data.reportingTo; }
  ...
  get performanceMetrics() { return this.data.performanceMetrics; }
  get assignedBay() { return this.data.assignedBay; }
  get specialization() { return this.data.specialization; }
  get toolsAssigned() { return this.data.toolsAssigned; }
  get currentTasks() { return this.data.currentTasks; }
  get systemAccess() { return this.data.systemAccess; }

...
export class Car {
  ...
  get lastServiceDate() {
    return this.data.lastServiceDate;
  }
  get nextServiceDate() {
    return this.data.nextServiceDate;
  }
  get serviceHistory() {
  ...
  get motExpiryDate() {
    return this.data.motExpiryDate;
  }
  get firstRegistrationDate() {
    return this.data.firstRegistrationDate;
  }
  get yearOfManufacture() {
    return this.data.yearOfManufacture;
  }
  get co2Emissions() {
    return this.data.co2Emissions;
  }
  get engineCapacity() {
    return this.data.engineCapacity;
  }
  get euroStatus() {
    return this.data.euroStatus;
  }
  get realDrivingEmissions() {
    return this.data.realDrivingEmissions;
  }
  get revenueWeight() {
    return this.data.revenueWeight;
  }
  get wheelplan() {
    return this.data.wheelplan;
  }
  get dateOfLastV5CIssued() {
    return this.data.dateOfLastV5CIssued;
  }

  get insuranceStatus() {
    return this.data.insuranceStatus;
  }
  get insuranceProvider() {
    return this.data.insuranceProvider;
  }
  get insurancePolicyNumber() {
    return this.data.insurancePolicyNumber;
  }
  get insuranceExpiryDate() {
    return this.data.insuranceExpiryDate;
  }
